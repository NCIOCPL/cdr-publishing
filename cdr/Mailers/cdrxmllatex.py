...
# log()
#
# Write through a log function, if present.  Else do nothing.
#
# Pass:
#   Logging function.
...
#   logFunc     Optional function for writing to a log file.
...
def makeLatex (Xml, docFmt, fmtType='', params=None, logFunc=None):
    ...
    if (type (Xml) == type ("") or type (Xml) == type (u'')):
        ...
        log (logFunc, "--Doc element extracted");
    ...
    log (logFunc, "--Executing processing tree")
