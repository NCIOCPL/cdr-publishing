#----------------------------------------------------------------------
#
# $Id: ProtocolRemailAbstractVerification.py,v 1.1 2002-01-28 09:36:24 bkline Exp $
#
...
class ProtocolAbstractMailer(cdrmailer.MailerJob):
    ...
    def __makeCoverSheet(self):
        ...
        f = open(filename, "w")
        f.write("\n\nUpdate Protocol Abstract Mailers\n\n")
    ...
    def __makeMailers(self):
        coverLetterName     = "../ProtUpdateAbstCoverLetter.tex"
