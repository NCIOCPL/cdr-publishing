%----------------------------------------------------------------------
%
% $Id: StatPartCoverLetter.tex,v 1.8 2007-04-24 18:03:19 bkline Exp $
%
% Template for the cover letter for a set of status and participant 
% site check mailers.
%
% $Log: not supported by cvs2svn $
% Revision 1.7  2007/04/11 17:08:01  bkline
% Added invitation to try the new Clinical Trials Submission portal.
%
% Revision 1.6  2006/06/15 13:10:16  bkline
% Replaced "Cancer Information Products and Systems" with "Office of
% Cancer Content Management."
%
% Revision 1.5  2003/04/15 19:00:55  bkline
% Fixed typos (PQ changed to PDQ).
%
% Revision 1.4  2003/02/19 16:57:09  bkline
% Removed "Cooperative Group" from subject string.
%
% Revision 1.3  2002/10/12 16:35:43  bkline
% First drafts of cover letters complete.
%
% Revision 1.2  2002/09/27 18:07:52  bkline
% Cleaned up comments.
%
% Revision 1.1  2002/09/27 18:06:13  bkline
% Cover letter for status and participant site check mailers.
%
%----------------------------------------------------------------------
